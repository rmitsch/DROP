...
DIM_RED_KERNELS_PARAMETERS: dict = {
    "TSNE": [
        {"name": "n_components", "type": "numeric", "values": [1, 3]},
        {"name": "perplexity", "type": "numeric", "values": [10, 100]},
        {"name": "early_exaggeration", "type": "numeric", "values": [1, 20]},
        {"name": "learning_rate", "type": "numeric", "values": [10, 250]},
        {"name": "n_iter", "type": "numeric", "values": [100, 1000]},
        {"name": "angle", "type": "numeric", "values": [0.35, 0.9]}
    ],
    # "TSNE": [
